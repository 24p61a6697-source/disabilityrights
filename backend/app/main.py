...
CHAT_TRANSLATIONS = {
    ...
    "rights": {
        ...
        "ml": "ഇന്ത്യയിൽ, വികലാംഗാവകാശങ്ങൾ 2016ലെ RPWD ആക്ടിന്റെ കീഴിൽ സംരക്ഷിതമാണ്. പ്രധാന അവകാശങ്ങളിൽ സമത്വം, പൊതു സ്ഥലങ്ങളിൽ പ്രവേശനം, വിദ്യാഭ്യാസം மറ്റും തൊഴിൽ, ആരോഗ്യപരിപാലനം, സാമൂഹ്യസുരക്ഷ എന്നിവയുണ്ട്.",    },
    "schemes": {
...
async def chat(
    ...
    try:
        ...
        # Return a localized service-unavailable message when possible
        try:
            localized = translate_chat_answer("service_unavailable", language)
        except Exception:
            localized = "Failed to process your request. Please try again."
